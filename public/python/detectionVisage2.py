...
while True:
    ...
    # Afficher la frame brute pour vérifier la capture vidéo
    ...
    # Afficher le nombre de visages détectés (pour débogage)
    ...
    # Affichage du résultat avec détection des visages
