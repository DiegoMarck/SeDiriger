...
# import cv2 #version black box ai pas de différence apparente avec version 1
# import pygame
...
# import cv2 version 2 chatGPT ne semble pas marcher non plus
# import pygame
...
# # Chargement du classificateur de cascade pour la détection de visages
# # face_cascade = cv2.CascadeClassifier(cv2.data.haarcascades + 'haarcascade_frontalface_default.xml')
# face_cascade = cv2.CascadeClassifier('C:/Users/ddema/OneDrive/Documents/Informatique/ProjetSeDiriger/sediriger/haarcascade_frontalface_default.xml')
